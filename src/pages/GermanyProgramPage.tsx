...
export default function GermanyProgramPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
            ...
            <div className="flex flex-col gap-6 lg:col-span-7">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-4">
                <Button 
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-6 text-base rounded-full shadow-lg hover:shadow-red-600/20 group"
                >
                  Book Free Counselling <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
                <button
                  type="button"
      ...
      <section id="programs" className="py-20 bg-slate-950 text-white relative">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-6xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { name: "Healthcare Assistant", cat: "Healthcare" },
              { name: "Home Health Assistant", cat: "Healthcare" },
              { name: "Nursing Assistant", cat: "Healthcare" },
              { name: "B.Voc in Healthcare Assistance & Integrated Patient Care", cat: "Healthcare" },
              { name: "Automobile Service & Mechatronics", cat: "Technical" },
              { name: "CNC Machine Operations", cat: "Technical" },
              { name: "Industrial Automation", cat: "Technical" },
            ].map((program, idx) => (
