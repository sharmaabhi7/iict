...
const navLinks = [
  ...
  { label: "IGSP", href: "/countries/germany", highlighted: true },
          ...
          {navLinks.map((l) =>
            l.children ? (
              ...
              <Link
                key={l.href}
                to={l.href}
                className={`text-[15px] font-semibold transition-all ${l.highlighted
              ...
              {navLinks.map((l) =>
                l.children ? (
                  ...
                  <Link
                    ...
                    to={l.href}
                    onClick={() => setOpen(false)}
                    className={`block rounded-lg px-3 py-2 text-sm font-semibold transition-all ${l.highlighted
